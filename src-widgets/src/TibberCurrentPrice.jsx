            ...
            visAttrs: [
                {
                    ...
                    fields: [
                        { name: 'oid_total',    type: 'id', label: { en: 'Total Price OID',     de: 'Gesamtpreis OID' } },
                        { name: 'oid_energy',   type: 'id', label: { en: 'Energy Price OID',    de: 'Energieanteil OID' } },
                        { name: 'oid_tax',      type: 'id', label: { en: 'Tax OID',             de: 'Steuer OID' } },
                        { name: 'oid_level',    type: 'id', label: { en: 'Price Level OID',     de: 'Preisstufe OID' } },
                        { name: 'oid_startsAt', type: 'id', label: { en: 'Price slot start OID',de: 'Preisslot Start OID' } },
                    ],
                },
                {
                    name: 'display',
                    ...
                    fields: [
                        { name: 'tib_title',       type: 'text',     label: { en: 'Title',                     de: 'Titel' },                  default: 'Tibber Strompreis' },
                        { name: 'tib_darkmode',    type: 'checkbox', label: { en: 'Dark mode',                 de: 'Dunkelmodus' },             default: true },
                        { name: 'show_breakdown',  type: 'checkbox', label: { en: 'Show energy/tax breakdown', de: 'Aufschlüsselung anzeigen' },default: true },
                        { name: 'currency',        type: 'text',     label: { en: 'Price unit label',          de: 'Preiseinheit' },            default: 'ct/kWh' },
                    ],
                },
            ],
        };
